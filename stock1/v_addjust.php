...
<section class="content">
	<form method="post" id="frmtranD" action="?d=stock1/addjust" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-12">
					...
					<div class="box-body">
							...
							<div class="form-group col-md-3">
								...
								<?php if ($_SESSION['EDPOSV1role_id']) { ?>
									<select class="form-control" name="infoID"
										onChange="document.location='index.php?d=stock1/addjust&infoID='+this.value">
										<?php
										$rs_info = LoadInfo();
						...
						<div class="row">
							<div class="form-group col-md-6">
								...
								<div class="input-group date">
									...
									<input type="text" name="txtDateTran" class="form-control pull-right"
						...
						<div class="row">
							<div class="form-group col-md-6">
								...
								<input type="text" name="txtreciever" class="form-control"readonly
						...
						<div class="row">
							<div class="form-group col-md-5">
								...
								<input type="text" name="txt_Release" class="form-control"
									value="<?= $_SESSION['EDPOSV1AddJust_Release'] ?>" required />
							</div>
							<div class="form-group col-md-5">
						...
						<div class="row">
							<div class="form-group col-md-12">
								...
								<textarea name="txtRemark" class="form-control" cols="50"
									rows="2"><?= $_SESSION['EDPOSV1AddJustRemark'] ?></textarea>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="form-group col-md-4">
								<label>ກຳນົດມື້ສົ່ງຄືນ</label>
								<div class="input-group date">
									<div class="input-group-addon">
										<i class="fa fa-calendar"></i>
									</div>
									<input type="date" name="txtDateReturn" class="form-control pull-right"
										id="datepicker1" data-date-format="yyyy-mm-dd"
										value="<?= $_SESSION['EDPOSV1AddJustDateWant'] ?>" required
										autocomplete="off" />
								</div>
			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-body pad table-responsive" style="overflow-x: auto;">
						...
						<table id="example21" class="table table-bordered table-hover beautified editable">
							<thead>
								<tr>
									<th>ລຳດັບ</th>
									<th>Barcode</th>
							...
							<tbody>
								...
								while ($item = mysql_fetch_array($SumResult)) {
									...
									<tr>
										...
										<td>
											<strong><input type="hidden" name="type[]" class="type" value="unchanged" />
												<input type="hidden" name="tranID[]" value="<?= $item['tranID'] ?>" />
												<input type="hidden" name="addInfoID[]" value="<?= $item['info_id'] ?>" />
