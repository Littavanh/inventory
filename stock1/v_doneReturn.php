<?php
session_start();
htmltage("ສຳເລັດຮັບສິນຄ້າເຂົ້າສາງຄືນ");
...
<section class="content-header">
    <h1>ສຳເລັດຮັບສິນຄ້າເຂົ້າສາງຄືນ</h1>
</section>
                                ...
                                <tbody>
                                    ...
                                    <div class="modal fade" id="modal-lg-doneAddjust<?= $i ?>" data-backdrop="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title ">ສຳເລັດຮັບສິນຄ້າເຂົ້າສາງຄືນ</h4>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <form method="post" action="?d=stock1/doneReturn"
                                    ...
                                    <tr>
                                        ...
                                        <td class="centered">
                                            <a
                                                href="index.php?d=stock1/doneReturnDetail&bId=<?= $row['transferID'] ?>"><i>ເບິ່ງລາຍລະອຽດ</i></a>
                                        </td>
                                        <!-- <td class="centered">
                                        ...
                                        <td class="centered">
                                            <h4><span class="label label-primary "
                                                    <?php if($row['status_get_id'] != 7){ ?> data-toggle="modal"
                                                    data-target="#modal-lg-doneAddjust<?= $i ?>" <?php } ?>>
                                                    <?= $row['statusGet'] ?> <i <?php if($row['status_get_id'] != 7){ ?>
