								...
								<tbody>
									...
									while ($row = mysql_fetch_array($load, MYSQL_ASSOC)) {
										...
										<tr>
											...
											<td class="centered">
												<a
													href="index.php?d=stock1/returnconfirmDetail&bId=<?= $row['transferID'] ?>"><i>ເບິ່ງລາຍລະອຽດ</i></a>
											</td>
											<!-- <td class="centered">
											...
											<td class="centered">
												<a class="btn btn-success"
													href="index.php?d=stock1/returnConfirm&approve=<?= $row['transferID'] ?>" onclick="return confirm('ທ່ານຕ້ອງການຢືນຢັນແທ້ບໍ່ ?')"><i>ຢືນຢັນສົ່ງຄືນສິນຄ້າ</i></a>
											</td>
