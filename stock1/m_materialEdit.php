<?php 
 $Get_infoID= $_SESSION['EDPOSV1info_id'];
	...
	$rsMaterial = mysql_query("select * from v_material_ WHERE status_id IN (3) AND materialID ='$id' and info_id='$GetM_InfoID' ");	
	$CountM = nr_execute("SELECT COUNT(*) FROM v_material_  WHERE status_id IN (3) AND materialID ='$id' and info_id='$GetM_InfoID' ");
	if ($CountM > 0) {
	...
	$_SESSION["EDPOSV1MADD_txtBarcode1"]="";
 	...
 	$rsRecipe1 = mysql_query("select * from v_recipe_ WHERE status_id IN (3) AND materialID ='$id' and info_id='$GetM_InfoID' and unitID='1' ");		
 	$rsRecipe2 = mysql_query("select * from v_recipe_ WHERE status_id IN (3) AND materialID ='$id' and info_id='$GetM_InfoID' and unitID='2' ");	
 	$rsRecipe3 = mysql_query("select * from v_recipe_ WHERE status_id IN (3) AND materialID ='$id' and info_id='$GetM_InfoID' and unitID='3' ");	
...
function selkindfood($SelInfoID){
	return mysql_query(" select * from tb_kind_food_ WHERE status_id=3 and info_id='$SelInfoID' ");
}
