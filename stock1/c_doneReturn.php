...
if (isset($_POST["btnSave"])) {
	...
	if ($tmp_file_name1 != "") {
		...
		sql_execute("UPDATE tb_export_ SET status_get_id='$cb_status',po_file_return='$file_name1',date_return3=NOW() WHERE `transferID`='$transferID'");
    ...
    from v_export_ WHERE `transferID`='$transferID'");
	}
	else {
