			...
			<div class="box box-primary">
				<div class="box-header with-border">
					...
					<div class="form-group col-md-3">
						...
						<select class="form-control" name="infoID" onChange="document.location='index.php?d=stock1/material&infoID='+this.value">
				...
				<div class="box-body">
					<button type="button" class="btn btn-default" onclick="document.location='?d=stock1/materialAdd'">ເພີ່ມຂໍ້ມູນ</button>
					<button type="button" class="btn btn-primary" onclick="document.location='?d=stock1/material_import'">Import Excel File</button>
					<div class="row">
						<div class="box-body pad table-responsive">
							<h4><?= $pagedescription ?></h4>
							<form method="post" id="frmPriceSetting" action="?d=stock1/material" enctype="multipart/form-data">
											...
											<tr>
								          	...
								          	<td><?= number_format($row['price2']) ?></td>
								          	 <td><?= number_format($row['price3']) ?></td> -->
												...
												<?php if (isset($_SESSION['EDPOSV1role_id']) && $_SESSION['EDPOSV1role_id'] != 4) { ?>
													<td class="centered">
														<a href="?d=stock1/materialEdit&edit_id=<?= base64_encode($row["materialID"] . "tasoksavhay"); ?>&infoid=<?= $row['info_id'] ?>">
															<i class="fa fa-pencil"></i></a>
													</td>
													<td class="centered">
														<a href="?d=stock1/material&del_id=<?= base64_encode($row["materialID"] . "tasoksavhay"); ?>&infoid=<?= $row['info_id'] ?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')">
