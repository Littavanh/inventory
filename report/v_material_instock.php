						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<p class="right"><a href="report/ex_material_instock.php?<?= $params ?>" target="_blank">
											<input type="button" value="Export To Excel" />
										</a></p>
									<p class="right"><a href="report/print_material_instock.php?<?= $params ?>" target="_blank">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<div align="left"><strong><?= $item['mBarcode'] ?></strong></div>
									</td>
									<td>
										<div align="left"><strong><?= $item['materialName'] ?></strong></div>
									</td>
