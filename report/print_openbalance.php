...
<table border="0" cellspacing="0" cellpadding="0">
       ...
       <td colspan="3" align="right">
        ...
        <tr>
	       	<td colspan="3">
	          <div align="center"><strong><font size="+1">ລາຍງານ ເປີດ/ປິດກະ</font></strong></div>
	  ...
	  <div id="to_control">
		<table  border="1">
		  <tr class="">			
			...
			<td width=""><font size="2"><strong>ເປີດ</strong></font></td>             
			<td width=""><font size="2"><strong>ປິດ</strong></font></td>
		  </tr>	 
			<?php 			
				$i=1;								
			...
			<tr>										
				...
				<td><font size="2"><?= $item['datetimeopen'] ?><br><?= $item['username'] ?><br><?= $item['remark'] ?></font>&nbsp;</td>
				<td><font size="2"><?= $item['datetimeclose'] ?><br><?= $item['usernameC'] ?><br><?= $item['remark_close'] ?></font>&nbsp;</td>  
			</tr> 				
			<?php $i++; } ?>	
		</table>		
