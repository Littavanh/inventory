...
<section class="content">
	<form method="post" id="" action="?d=stock/returnDetail&bId=<?= $_SESSION['bId'] ?>" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					...
					<div class="box-body">
						<button type="reset" class="btn btn-default"
							onclick="document.location='?d=stock/returnHistory'">ປິດ</button>
						<div class="row">
