...
if (isset($_GET["approve"])) {
	...
	//   echo '<script>alert("'.$transferID.'")</script>';
...
if (isset($_POST["btnSave"])) {
	...
	sql_execute("UPDATE tb_export SET status_approve_id='4',remark_reject='$remarkReject' WHERE `transferID`='$transferID'");
	sql_execute("UPDATE tb_transactiond SET status_id='11' WHERE `transferID`='$transferID'");
