<?php
session_start();
htmltage("ລາຍລະອຽດ ສົ່ງຄືນສິນຄ້າ");
...
<section class="content-header">
	<h1>ລາຍລະອຽດ ສົ່ງຄືນສິນຄ້າ</h1>
</section>
<section class="content">
	<form method="post" id="" action="?d=stock/returnConfirmDetail&bId=<?= $_SESSION['bId'] ?>" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					...
					<div class="box-body">
						<button type="reset" class="btn btn-default"
							onclick="document.location='?d=stock/returnConfirm'">ປິດ</button>
						<div class="row">
