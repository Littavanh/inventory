	 ...
	 $("#frmreceive").validate({
    	...
    	messages: {
			...
			*/
			...
			"eq_no[]": {required: "</label><span class = 'req_err' style=\"display:inline;\">ເລືອກສິນຄ້າ ຕາມລະຫັດ !</span><label>"
			},
			...
			"eq_name[]": {required: "</label><span class = 'req_err' style=\"display:inline;\">ເລືອກສິນຄ້າ ຕາມຊື່ !</span><label>"},
	 ...
	 $("#frmDelivery").validate({
    	...
    	messages: {
			...
			"refer_file": {required: "<br />ແນບເອກະສານກ່ອນ !"},
    	   	/*-------------- the table enter equipment -------------*/
			"eq_code[]": {required: "</label><span class = 'req_err' style=\"display:inline;\">ເລືອກສິນຄ້າ ຕາມລະຫັດ !</span><label>"
			},
