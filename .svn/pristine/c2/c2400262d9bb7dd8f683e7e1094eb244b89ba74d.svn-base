			            ...
			            <div class="row">			                
			                <div class="col-md-6">
				                 ...
				                 <div class="form-group">
					                <label>ສາງ</label>
					                <select class="form-control" name="infoID" onChange="document.location='index.php?d=report/material_min&infoID='+this.value">
				                ...
				                <div class="form-group">
									<p><a href="report/ex_material_min.php?<?=$params?>" target="_blank">
