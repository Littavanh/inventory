	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				<form method="get">
					<input type="hidden" name="d" value="report1/stock_transfer" />
					<div class="box-body">
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									<p class="right"><a href="report1/ex_stock_transfer.php?<?= $params ?>"
											target="_blank">
					...
					<div class="box-footer">
						<button type="reset" class="btn btn-default"
							onclick="document.location='?d=report1/stock_transfer'">ຍົກເລີກ</button>
