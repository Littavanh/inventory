...
if (isset($_POST['btnConfirmReturn'])) {
  if (isset($_POST['type'])) {
    ...
    for ($i = 0; $i < count($_POST['type']); $i++) {
      ...
      sql_execute("UPDATE tb_export SET status_get_id='5',qty_used= '$txtUsed',qty_return= '$txtReturn', return_approver= '$lineManagerId',date_return2= NOW(),remark_return= '$txtRemark' WHERE traDID='$txttraDID'");
    }
