...
<form method = "post" action="?d=manage/info_list" enctype="multipart/form-data">
<div class="infobox">
...
<div class="col-md-12">
	<div class="col-md-3">
		<div class="form-group">
			<img src="logo/<?=$_SESSION['EDPOSV1show_image_name'] ?>" width="250" height="250" />	
		</div>
	</div>
	<div class="col-md-9">
		<div class="col-md-12">
			<div class="form-group">
				<label style="font-size: 18px; ">LOGO</label>
		...
		<div class="col-md-12"> 
			<div class="menubox">			
		        ...
		        <input type="submit"  name ="btncancel_logo" class = "btn btn-app" value=" ປິດ " />
