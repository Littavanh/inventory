  ...
  <?php if (isset($_SESSION['EDPOSV1user_id'])) {  ?>
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              $dateView = new DateTime('now', new DateTimeZone('Asia/Vientiane'));
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="users_pic/user_256.png" class="user-image" alt="User Image">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2018 <a href="https://www.facebook.com/EG-POS-209297582890361">Dev Lao world</a>.</strong> All rights reserved.
      </footer>
