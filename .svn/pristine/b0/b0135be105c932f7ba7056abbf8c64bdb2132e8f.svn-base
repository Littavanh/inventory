...
<div id="cover">
	<div id="dialogparent">
		...
		<div id="dialog">
			...
			<div class="searchbox">
				<form method="get">
					<input type="hidden" name="d" value="stock1/recieve" />
					<table class="">
						<tr>
							<td>ຄົ້ນຫາ: </td>
							<td>
								<select name="materialID" onchange="document.location='?d=stock1/recieve&materialID='+this.value">
			...
			<form method="post" action="?d=stock1/recieve" enctype="multipart/form-data">
