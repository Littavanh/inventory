				...
				<div class="box-body">
					<div class="row">
						<div class="box-body pad table-responsive">
							<form method="post" id="frmroomtype" action="index.php?d=manage/info_list1">
										...
										while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {  ?>
											<tr>
												...
												<?php if ($_SESSION['EDPOSV1role_id'] <= 3) { ?>
													...
													<td class="centered">
														<a href="index.php?d=manage/info_list1&del_id=<?= $row["info_id"] ?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')"><i class="fa fa-trash-o"></i></a>
													</td>
												<?php } ?>
											</tr>
										<?php $i++;
