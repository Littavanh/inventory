	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				<form method="get">
					<input type="hidden" name="d" value="report1/inventory_movement" />
					<div class="box-body">
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									<p class="right"><a href="report1/ex_inventory_movement.php?<?= $params ?>" target="_blank">
					...
					<div class="box-footer">
						<button type="reset" class="btn btn-default" onclick="document.location='?d=report1/inventory_movement'">ຍົກເລີກ</button>
