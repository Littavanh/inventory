    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form method="post" id="frmtranH" action="?d=stock/recieveSub" enctype="multipart/form-data">
                    <div class="box-body">
                        <!-- <div class="row">
                        ...
                        <div class="row col-md-6 " hidden>
                            <div class="form-group col-md-2">
                                ...
                                <input type="radio" name="invenType" value="1" > ທົ່ວໄປ<br>
                         
                            </div>
                            <div class="form-group col-md-2">

                             
                                <input type="radio" name="invenType" value="2" checked> ຄັ່ງຍ່ອຍ<br>
                            </div>
                        </div>
                    </div>
        ...
        <?php if ($catcount > 0) { ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <form method="post" id="frmtranD" action="?d=stock/recieveSub" enctype="multipart/form-data">
                                        ...
                                        while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) { ?>
                                            <tr>
                                                ...
                                                <?php if (isset($_SESSION['EDPOSV1role_id']) && $_SESSION['EDPOSV1role_id'] != 4) { ?>
                                                    <td class="centered">
                                                        <a
                                                            href="?d=stock/recieveSub&del_id=<?php echo base64_encode($row["tmpDID"] . "tasoksavhay"); ?>&delinfoid=<?= $row['info_id'] ?>">
