										...
										while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {  ?>
											<tr>
												<td class="eqcodecols">
													...
													<input type="text" name="txtSuppliername[]" size="" value="<?= $row['supplierName'] ?>" required autocomplete="off" />
													<label class="hidden"><?= $row['supplierName'] ?></label>
												</td>
												<td class="eqcodecols">
													<input type="text" name="ContactName[]" size="" value="<?= $row['ContactName'] ?>" required autocomplete="off" />
													<label class="hidden"><?= $row['ContactName'] ?></label>
												</td>
												<td class="eqcodecols">
													<input type="text" name="txtTel[]" size="" value="<?= $row['tel'] ?>" required autocomplete="off" />
													<label class="hidden"><?= $row['tel'] ?></label>
												</td>
												<td class="eqcodecols">
													<input type="text" name="txtemail[]" size="" value="<?= $row['email'] ?>" autocomplete="off" />
													<label class="hidden"><?= $row['email'] ?></label>
												</td>
												<td class="eqcodecols">
													<input type="text" name="txtAddr[]" size="" value="<?= $row['addr'] ?>" required autocomplete="off" />
													<label class="hidden"><?= $row['addr'] ?></label>
												</td>
												<td class="eqcodecols">
													<input type="text" name="txtRemark[]" value="<?= $row['remark'] ?>" autocomplete="off" />
...
<table class="template hidden" id="tab">
	<tr>
		...
		<td class="eqcodecols"><input type="text" name="ContactName[]" size="" value="" required autocomplete="off" /></td>
