	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				...
				<form method="post" id="frmtranH" action="?d=stock1/recieve" enctype="multipart/form-data">
					<div class="box-body">
						<!-- <div class="row">
						...
						<div class="row col-md-4 ">
							<div class="form-group col-md-10">
								...
								<div class="input-group date">
									...
									<input type="text" name="txtDate" class="form-control pull-right" id="datepicker1"
							...
							<div class="form-group col-md-2">
								...
								<div class="input-group date">
									...
									<input type="date" name="txtBill_date" class="form-control pull-right"
										id="datepicker2" autocomplete="off" data-date-format="yyyy-mm-dd"
		...
		<?php if ($catcount > 0) { ?>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<form method="post" id="frmtranD" action="?d=stock1/recieve" enctype="multipart/form-data">
										...
										while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) { ?>
											<tr>
												...
												<?php if (isset($_SESSION['EDPOSV1role_id']) && $_SESSION['EDPOSV1role_id'] != 4) { ?>
													<td class="centered">
														<a
															href="?d=stock1/recieve&del_id=<?php echo base64_encode($row["tmpDID"] . "tasoksavhay"); ?>&delinfoid=<?= $row['info_id'] ?>">
