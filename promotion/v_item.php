...
<div id="cover">
	<div id="dialogparent">
		<div class="mask"></div>
		<div id="dialog">
			<h1 class="h1 centered">ລາຍການສິນຄ້າ ກໍານົດປະເພດສິນຄ້າທີ່ຂາຍ</h1>
			<form method = "post" name="fcalulate">
				...
				<div class="col-md-12">			
						<div class="form-group menubox" align='left'>
				        	...
				        	<input type="submit" name="btnSaveItem" class= "btn btn-app" style="color:#FFF; background:#00a65a; border:#008d4c" value = "ເພີ່ມກໍານົດ ສິນຄ້າທີ່ຂາຍ"  />
