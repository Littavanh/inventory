<?php htmltage("ລາຍງານຮັບສິນຄ້າເຂົ້າສາງ (ລວມ)");
date_default_timezone_set("Asia/Vientiane"); ?>


<link type="text/css" rel="stylesheet" href="css/element.css" />
<section class="content-header">
	<h1>ລາຍງານຮັບສິນຄ້າເຂົ້າສາງ (ລວມ)</h1>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				<form method="get">
					<input type="hidden" name="d" value="report1/receiveT" />
					<div class="box-body">
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<p class="right"><a href="report1/ex_receiveT.php?<?= $params ?>" target="_blank">
					...
					<div class="box-footer">
						<button type="reset" class="btn btn-default" onclick="document.location='?d=report1/receiveT'">ຍົກເລີກ</button>
					...
					<table id="example1" class="table table-bordered beautified_report">
							...
							?>
								...
								?>
									...
									<tr>
										...
										<td><?= number_format(($itemD['pur_price'] * $itemD['unitQty3']) - ($itemD['receive_dis'] * $itemD['unitQty3']),2, '.', ',') ?></td>
						...
						<tfoot>
							...
							<tr style="color:#FFF" bgcolor="#999999">
								...
								<td colspan="5" align="center"><strong>ລວມມູນຄ່າ ຮັບສິນຄ້າເຂົ້າສາງ ປະຈໍາເດືອນ <?= $_GET['startdate']  ?> </strong></td>
								<td align="center"><strong><?= number_format(LoadCount_Qty3($whereclause),2, '.', ',') ?></strong></td>
								<td align="right"><strong><?= number_format(LoadCount_Cur('ກີບ', $whereclause),2, '.', ',') ?></strong></td>
								<td align="right"><strong>ກີບ</strong></td>
							</tr>
							<tr style="color:#222">
								<td colspan="6" align="center"></td>
							
								<td align="right"><strong><?= number_format(LoadCount_Cur('ບາດ', $whereclause),2, '.', ',') ?></strong></td>
								<td align="right"><strong>ບາດ</strong></td>
							</tr>
							<tr style="color:#222 ">
								<td colspan="6" align="center"></td>
								
								<td align="right"><strong><?= number_format(LoadCount_Cur('ໂດລາ', $whereclause),2, '.', ',') ?></strong></td>
